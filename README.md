...
The figures below illustrate this behavior using an example.
...
These notes have been added as part of task 2 of the markdown exercises.

These are going to be list items:
...
1. Item One Numbered Causing Merge Conflict from branch-B
2. Item One Numbered
